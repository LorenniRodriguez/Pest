                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="nombres" id="nombres" placeholder="Nombres del cliente" 
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="telefono" id="telefono" placeholder="Numero de Teléfono" 
                    ...
                    <div class="row">
                       <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="apellidos" id="apellidos" placeholder="Apellidos del cliente" 
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                         <label class="col-sm-3 col-form-label">Celular:</label>
                          <div class="col-sm-9">
                            <input name="celular" id="celular" placeholder="Numero de Celular" 
                    ...
                    <div class="row">
                      <div class="col-md-6">
                       <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="edad" id="edad" placeholder="Edad del Cliente" 
                            value="{{ $cliente->edad }}"type="text" class="form-control" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                         <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="cedula" id="cedula" placeholder="" type="text" 
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name="correo" id="correo" placeholder="" type="text" 
