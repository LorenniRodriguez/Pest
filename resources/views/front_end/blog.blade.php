					...
					<div class="left-blog">
						<div class="blog-left">
							<div class="blog-left-left">
								...
								<a href="single.html"><img src="{{ asset('front_end/images/b1.jpg') }}" alt="" /></a>
							</div>
						...
						<div class="blog-left">
							<div class="blog-left-left">
								<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on June 2, 2015 &nbsp;&nbsp; <a href="#">Comments (10)</a></p>
								<a href="single.html"><img src="{{ asset('front_end/images/b2.jpg') }}" alt="" /></a>
							</div>
						...
						<div class="blog-left">
							<div class="blog-left-left">
								<p>Posted By <a href="#">Admin</a> &nbsp;&nbsp; on June 2, 2015 &nbsp;&nbsp; <a href="#">Comments (10)</a></p>
								<a href="single.html"><img src="{{ asset('front_end/images/b3.jpg') }}" alt="" /></a>
							</div>
							<div class="blog-left-right">
								<a href="single.html">Phasellus ultrices tellus eget ipsum ornare molestie</a>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Sed blandit massa vel mauris sollicitudin 
					...
					<div class="comments">
						...
						<div class="comments-text">
							<div class="col-md-3 comments-left">
								<img src="{{ asset('front_end/images/t1.jpg') }}" alt="" />
							</div>
						...
						<div class="comments-text">
							<div class="col-md-3 comments-left">
								<img src="{{ asset('front_end/images/t2.jpg') }}" alt="" />
							</div>
							<div class="col-md-9 comments-right">
								<h5>Admin</h5>
								<a href="#">Phasellus sem leointerdum risus</a> 
						...
						<div class="comments-text">
							<div class="col-md-3 comments-left">
								<img src="{{ asset('front_end/images/t3.jpg') }}" alt="" />
							</div>
							<div class="col-md-9 comments-right">
								<h5>Admin</h5>
								<a href="#">Phasellus sem leointerdum risus</a> 
