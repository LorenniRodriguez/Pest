			...
			<div class="container">
				...
				<div class="agileinfo-top-grids">
					<div class="col-sm-4 wthree-top-grid">
						<img src="{{ asset('front_end/images/a1.jpg') }}" alt="" />
					...
					<div class="col-sm-4 wthree-top-grid">
						<img src="{{ asset('front_end/images/a2.jpg') }}" alt="" />
						<h4>Curabitur non blandit justo</h4>
						<p>Pellentesque auctor euismod lectus a pretium. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Curabitur ut elit at est tempus volutpat.nascetur ridiculus mus. Curabitur ut elit at est tempus volutpat.</p>
					</div>
					<div class="col-sm-4 wthree-top-grid">
						<img src="{{ asset('front_end/images/a3.jpg') }}" alt="" />
						<h4>Curabitur non blandit justo</h4>
						<p>Pellentesque auctor euismod lectus a pretium. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Curabitur ut elit at est tempus volutpat.nascetur ridiculus mus. Curabitur ut elit at est tempus volutpat.</p>
					</div>
				...
				<div class="agile_team_grids">
					<div class="col-md-3 agile_team_grid">
						<div class="agile_team_grid_main">
							<img src="{{ asset('front_end/images/t2.jpg') }}" alt=" " class="img-responsive">
							<div class="p-mask">
					...
					<div class="col-md-3 agile_team_grid">
						<div class="agile_team_grid_main">
							<img src="{{ asset('front_end/images/t1.jpg') }}" alt=" " class="img-responsive">
							<div class="p-mask">
								<ul class="top-links two">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter"></i></a></li>
					...
					<div class="col-md-3 agile_team_grid three">
						<div class="agile_team_grid_main">
							<img src="{{ asset('front_end/images/t3.jpg') }}" alt=" " class="img-responsive">
							<div class="p-mask">
								<ul class="top-links two">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter"></i></a></li>
					...
					<div class="col-md-3 agile_team_grid four">
						<div class="agile_team_grid_main">
							<img src="{{ asset('front_end/images/t4.jpg') }}" alt=" " class="img-responsive">
							<div class="p-mask">
								<ul class="top-links two">
									<li><a href="#"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#"><i class="fa fa-twitter"></i></a></li>
